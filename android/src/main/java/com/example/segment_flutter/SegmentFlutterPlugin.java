package com.example.segment_flutter;
...
/** SegmentFlutterPlugin */
  public class SegmentFlutterPlugin implements MethodCallHandler, FlutterPlugin {
  ...
  private void setupChannels(Context applicationContext, BinaryMessenger messenger) {
    try {
      methodChannel = new MethodChannel(messenger, "segment_flutter");
